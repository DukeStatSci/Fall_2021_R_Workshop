...
Now in github.com, search for the following repository: https://github.com/DukeStatSci/Spring_2021_Workshop
...
We can use just part of the dataset by filtering. Here, we are going to filter on a particular value of cut and color and plot price vs carat. Try filtering another variable.
